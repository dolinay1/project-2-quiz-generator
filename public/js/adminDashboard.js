$(document).ready(() => {
  ...
  $.get("/api/user_data").then(userData => {
    ...
    $.get(queryURL, function (quizData) {
...
<span class="border m-2 px-64 py-2 bg-teal-100">Quiz name: ${quizData.quizName}, Category: ${quizData.category}, Date created: ${quizData.createdAt}</span>
</li>`)
      }
    });
  });
